...
<script type="text/javascript">
	...
	$(document).ready(function(){	
		...
		$(document).on("click", "#SALL", function(){
			$("#memSelectAllForm").attr({"method":"GET",
		...
		$(document).on("click", "#U", function(){
			...
			$("#memSelectAllForm").attr({
				"method":"GET", "action":"memSelect.k"}).submit();
		});
		...
		$(document).on("click", "#D", function(){	
			...
			$("#memSelectAllForm").attr({ "method":"GET", "action":"memSelect.k"}).submit();
		});
	});
...
<font size="4" color="blue">
	<img src="/springKbd/img/img_mandu/ase.gif" width="25" height="25" alter="image">
	MEMBER TEST
</font>
</td>
</tr>
...
<tr>
	...
	<td class="tt"><img src="/springKbd/fileupload/member/<%= mvo.getMphoto() %>" border="1" width="50" height="50" alt="image"></td>
