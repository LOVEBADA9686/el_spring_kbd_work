...
public class SpringBoardController {
	...
	public String boardInsert(HttpServletRequest req) {
		...
		logger.info("SpringBoardConroller boardInsert _bvo.getSbnum() >>> : " + _bvo.getSbnum());
		logger.info("SpringBoardConroller boardInsert _bvo.getSbcontent() >>> : " + _bvo.getSbcontent());
		logger.info("SpringBoardConroller boardInsert _bvo.getSbfile() >>> : " + _bvo.getSbfile());
		int nCnt = springBoardService.boardInsert(_bvo);
		logger.info("SpringBoardController boardInser nCnt >>> : " + nCnt);
...
//		}
	...
	public String boardSelectAll(SpringBoardVO bvo, Model model) {
		...
		logger.info("SpringBoardController boardSelectAll bvo.getKeyKeyword() >>> : " + bvo.getKeyword());
		...
		logger.info("SpringBoardController boardSelectAll.size() >>> : " + listAll.size());
